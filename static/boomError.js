function BoomError(e, filename, functionName, line, col) {

	function errorTitle() {

		var ctitle = document.createElement('span')
		ctitle.textContent = 'BOOM-ERROR'
...
var boomError = function(e, fileName, functionName, line, col) {

	var container = new ErrorContainer()

	container.log(new BoomError(e, fileName, functionName, line, col))
}